              ...
              <div class="card">
                <div class="card-header p-2">
                  <ul class="nav nav-pills">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="overdue.php">Overdue </a></li>
                  </ul>
                </div>
                <div class="card-body">
                  <div class="tab-content">
                    <div class="active tab-pane">
                      ...
                      <div class="post">
                        <table id="example1" class="table table-striped tble3">
                          <thead>
                            <tr>
                              <th>Room No.</th>
                              <th>Name</th>
  ...
  <script>
    $(document).ready(function() {
      $("#example1").DataTable({
        ...
        "searching": true // Ensure search functionality remains active
