    ...
    <div class="content-wrapper">
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-3">
            <div class="col-sm-6">
              <h1>Monthly Maintenance Summary </h1>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-12">
              <div class="info-box">
                ...
                if (isset($_GET['room_id']) && isset($_GET['year'])) {
                  ...
                  WHERE maintenance.room_id = $room_id AND YEAR(maintenance.date) = $year 
                  GROUP BY room.room_id, maintenance_year 
                ...
                <div class="info-box-content">
                  <span class="info-box-text">Monthly Maintenance Cost</span>
                    ...
                    <table id="example1" class="table table-striped ">
                      ...
                      <tbody>
                        ...
                        if (isset($_GET['room_id']) && isset($_GET['year'])) {
                          ...
                          FROM maintenance 
                          INNER JOIN room ON maintenance.room_id = room.room_id 
                          WHERE room.room_id = $room_id AND YEAR(maintenance.date) = $year 
