    ...
    <div class="content-wrapper">
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-3">
            <div class="col-sm-6">
              <h1>Overall Maintenance Summary </h1>
            </div>
          </div>
          <div class="row">
            <div class="col-md-3 col-sm-6 col-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">Overall Maintenance Cost</span>
                    ...
                    <table id="example1" class="table table-striped ">
                      <thead>
                        <tr>
                          ...
                          <th style="width: 33%;">Total Cost</th>
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <td>
                              <a href="room-maintenance-yearly.php?room_id=<?php echo $room_id ?>">
                              <?php
                              echo date('M Y', strtotime($start_date)) . ' - ' . date('M Y', strtotime($end_date));
                              ?>
                              </a>
                            </td>
                          </tr>
