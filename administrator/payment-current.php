              ...
              <div class="card">
                <div class="card-header">
                  <ul class="nav nav-pills">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="payment-current.php">Due Today</a></li>
                ...
                <div class="card-body">
                  <table id="example1" class="table  table-striped">
                    ...
                    <tbody>
                      ...
                      $fetch_duetoday_payment = fetch_duetoday_payment($conn);
                      while ($result = mysqli_fetch_array($fetch_duetoday_payment)) {
                        extract($result);
